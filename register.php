<?php  
    ...
    if ($data->num_rows > 0) {
        ...
        header("Registeration success");
    } else 
      exit('Please check your Credentials');
  }              
?>
<html>
  <head>
...
.registerbtn:hover {
  opacity: 1;
    ...
    <h3>Please fill the form to create an account.</h3>
        ...
        <input type="button" value="Register" id= "register" class="registerbtn" ><span id="errorform" style="color: red;"></span><span id="success" style="color: greenyellow;"></span><br><br>
...
<p id='response'>
   ...
   function validatelname(){
    ...
    $("#register").on('click', function () {
               ...
               if (firstName != "" && lastName != "" && email != "" && password != "" && pswrepeat != "") {
                    $.ajax({
                        url: 'register.php',
                        method: 'POST',
                        dataType: 'text',
                        data: {
                            ...
                            else if (response === 'failedName')
                                alert('Username must be atleast 3 characters!');
                            else if (response === 'failedpsw')
